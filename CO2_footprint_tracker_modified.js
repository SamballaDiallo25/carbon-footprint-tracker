...
const SUPABASE_URL = 'https://gnhxehilbwajdkemtdyi.supabase.co'; // Replace with your actual Supabase URL
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImduaHhlaGlsYndhamRrZW10ZHlpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTEyMjA4MTUsImV4cCI6MjA2Njc5NjgxNX0.zU-HfZR-ah2lHUelOkVZkX1l9tzsnKr5S3DFSgPrxHA'; // Replace with your actual anon key
...
async function registerUser(name, email, password) {
    try {
        ...
        if (authData.user) {
            ...
            return null; // User needs to verify email first
        }
    } catch (error) {
...
async function loadUserActivities() {
    ...
    try {
        ...
        currentUser.activities = activities.map(activity => ({
            id: activity.id,
...
async function addActivity(category) {
    if (!currentUser) return;
    ...
    try {
        ...
        // Add to local activities array with the returned ID
...
// Modified deleteActivity function
...
// Keep all your existing utility functions and UI functions unchanged
// (showApp, toggleTheme, setTheme, toggleUserMenu, showSection, etc.)
...
// Carbon footprint emission factors (unchanged)
